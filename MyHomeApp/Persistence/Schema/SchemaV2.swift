...
/// VersionedSchema v2.0.0 — adds the Category model and the Expense ↔ Category relationship.
///
/// Rules:
/// - SchemaV1.swift is IMMUTABLE after v1 ships. Never edit it.
/// - SchemaV2 is an additive superset: it copies SchemaV1.Expense verbatim and adds:
///   (a) a new Category @Model, and
///   (b) a to-many categories relationship on Expense.
///
...
/// 6. UUID primary key on both @Model types.
/// 7. All relationships optional with explicit inverse declared on both sides (rule 4).
/// 8. Delete rule .nullify on all relationships (no .cascade on shared objects).
enum SchemaV2: VersionedSchema {
    ...
    final class Category {
        ...
        // Inverse side of the to-many relationship (CloudKit rule 4: inverse declared on one side).
    ...
    // MARK: - Expense @Model (copy of SchemaV1.Expense + categories relationship)
    ...
    final class Expense {
        ...
        // v1 UI surfaces single-select; schema models multiple for future-proof migration (D2-02).
