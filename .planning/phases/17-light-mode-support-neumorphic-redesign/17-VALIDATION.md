...
| 17-04-01 | 04 | 4 | D-05, D-06, D-08 | T-17-05 | no alpha multiplication on adaptive tokens | unit+render | quick run + dark diff | ✅ | ⬜ pending |
| 17-04-02 | 04 | 4 | D-04, D-05 | — | N/A | unit + manual-visual | quick run; light screenshots (tuning is the deliverable) | ✅ | ⬜ pending |
| 17-04-03 | 04 | 4 | D-06 (preview hygiene) | — | N/A | build+grep | 4 light preview pins | ✅ | ⬜ pending |
| 17-05-01 | 05 | 5 | D-11/12/13, D-06 | T-17-06 | override on content only | unit+render+grep | quick run + dark diff + env-override count | ✅ | ⬜ pending |
| 17-05-02 | 05 | 5 | D-12, D-14, D-06 | T-17-06 | same | unit+render+grep | quick run + dark diff + 2 override sites | ✅ | ⬜ pending |
| 17-05-03 | 05 | 5 | D-13 | — | N/A | unit + manual-visual | quick run (dishSlate contrast floors) | ✅ | ⬜ pending |
| 17-06-01 | 06 | 6 | D-12, D-06 | T-17-07 | light-only insets never render in dark | unit+render+grep | quick run + dark diff tabs 0/3/analytics + zero #FFB43C | ✅ | ⬜ pending |
| 17-06-02 | 06 | 6 | D-09 | — | N/A | unit+grep+visual | quick run + zero hex in IconTile | ✅ | ⬜ pending |
| 17-06-03 | 06 | 6 | D-15 | — | N/A | unit+grep+visual | quick run + aiViolet scope == 2 files | ✅ | ⬜ pending |
| 17-07-01 | 07 | 7 | D-06 (final gate) | — | N/A | full suite+render | full suite + double dark sweep exit 0 | ✅ | ⬜ pending |
| 17-07-02 | 07 | 7 | D-01/02/14 + A2/A7 | T-17-08 | blur over light surfaces | scripted+human-check | light set ≥6 + end-of-phase sign-off | ✅ | ⬜ pending |
