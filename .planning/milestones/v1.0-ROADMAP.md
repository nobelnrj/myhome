...
- [x] 06-04-PLAN.md — SystemGmailAuth + SystemKeychainStore + GmailOAuthConfig + Gmail Settings section + RootView wiring + Info.plist URL type (ING-01/02/03/05/16, SEC-03, SET-04/05)
...
| 6. Gmail Sign-In & Client | 4/4 | Complete   | 2026-06-02 |
